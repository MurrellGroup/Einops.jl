...
*   [ ] Explore integration with `PermutedDimsArray` or [TransmuteDims.jl](https://github.com/mcabbott/TransmuteDims.jl) for lazy and statically inferrable permutations (see [#4](https://github.com/MurrellGroup/Einops.jl/issues/4)).
*   [ ] Implement `einsum` (or wrap existing implementation) (see [#3](https://github.com/MurrellGroup/Einops.jl/issues/3)).
